...
import com.mycompany.myrestapp.domain.Car;
import com.mycompany.myrestapp.repository.CarRepository;
...
import static com.mycompany.myrestapp.web.rest.TestUtil.createFormattingConversionService;
...
public class CarResourceIT {
    ...
    private static final Integer DEFAULT_VIN = 1;
    private static final Integer UPDATED_VIN = 2;
